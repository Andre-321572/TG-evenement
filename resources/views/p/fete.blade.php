...
@section('title', '| Fêtes & Célébrations')
...
<main class="container py-5 text-white animate__animated animate__fadeIn">
    ...
    <section class="glass-card rounded-3xl p-6 md:p-8 lg:p-10 mb-12 relative overflow-hidden text-center border border-white/10">
        ...
        <div class="absolute -bottom-24 -left-24 w-80 h-80 bg-amber-500/10 rounded-full filter blur-[80px] pointer-events-none"></div>
        
        <div class="relative z-10 max-w-2xl mx-auto py-4">
            <span class="w-16 h-16 rounded-full bg-gradient-to-tr from-amber-500 to-indigo-500 flex items-center justify-center text-white fs-3 mx-auto mb-4 shadow-lg shadow-indigo-500/20">
                <i class="fas fa-glass-cheers"></i>
            </span>
            <h1 class="fw-extrabold text-white mb-2 fs-2 leading-tight">Fêtes & Sorties</h1>
            <p class="text-indigo-200 fs-5 mb-4 font-medium">Célébrez chaque moment comme s'il était unique</p>
            <p class="text-gray-400 small leading-relaxed">Découvrez les meilleures soirées privées, dîners gastronomiques, barbecues géants et célébrations communautaires pour partager de bons moments en famille ou entre amis.</p>
        ...
        <div class="row g-4">
            ...
            @empty
                <div class="col-12 text-center py-5 glass-card rounded-3xl">
                    ...
                    <h4 class="text-gray-400">Aucun événement festif disponible</h4>
                    <p class="text-gray-500 small">Revenez plus tard pour voir les nouveaux événements festifs !</p>
                </div>
            @endforelse
        </div>
