...
@section('title', '| Concerts & Festivals de Musique')
...
<main class="container py-5 text-white animate__animated animate__fadeIn">
    ...
    <section class="glass-card rounded-3xl p-6 md:p-8 lg:p-10 mb-12 relative overflow-hidden text-center border border-white/10">
        ...
        <div class="absolute -bottom-24 -left-24 w-80 h-80 bg-pink-500/10 rounded-full filter blur-[80px] pointer-events-none"></div>
        
        <div class="relative z-10 max-w-2xl mx-auto py-4">
            <span class="w-16 h-16 rounded-full bg-gradient-to-tr from-pink-500 to-indigo-500 flex items-center justify-center text-white fs-3 mx-auto mb-4 shadow-lg shadow-indigo-500/20">
                <i class="fas fa-music"></i>
            </span>
            <h1 class="fw-extrabold text-white mb-2 fs-2 leading-tight">Concerts & Festivals</h1>
            <p class="text-indigo-200 fs-5 mb-4 font-medium">La musique en live, l'émotion en direct</p>
            <p class="text-gray-400 small leading-relaxed">Découvrez les performances les plus vibrantes, des concerts intimistes aux grands festivals de musique électronique, jazz, afrobeat et bien plus encore.</p>
        ...
        <div class="row g-4">
            ...
            @empty
                <div class="col-12 text-center py-5 glass-card rounded-3xl">
                    ...
                    <h4 class="text-gray-400">Aucun concert ou festival disponible</h4>
                    <p class="text-gray-500 small">Revenez plus tard pour voir les nouveaux événements musicaux !</p>
                </div>
            @endforelse
        </div>
