        ...
        <div class="row g-4">
            ...
            @empty
                <div class="col-12 text-center py-5 glass-card rounded-3xl">
                    ...
                    <h4 class="text-gray-400">Aucun événement de santé disponible</h4>
                    <p class="text-gray-500 small">Revenez plus tard pour voir les nouveaux événements bien-être et santé !</p>
                </div>
            @endforelse
        </div>
