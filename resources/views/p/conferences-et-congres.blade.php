...
@section('title', '| Conférences & Congrès')
...
<main class="container py-5 text-white animate__animated animate__fadeIn">
    ...
    <section class="glass-card rounded-3xl p-6 md:p-8 lg:p-10 mb-12 relative overflow-hidden text-center border border-white/10">
        ...
        <div class="absolute -bottom-24 -left-24 w-80 h-80 bg-blue-500/10 rounded-full filter blur-[80px] pointer-events-none"></div>
        
        <div class="relative z-10 max-w-2xl mx-auto py-4">
            <span class="w-16 h-16 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-500 flex items-center justify-center text-white fs-3 mx-auto mb-4 shadow-lg shadow-indigo-500/20">
                <i class="fas fa-microphone"></i>
            </span>
            <h1 class="fw-extrabold text-white mb-2 fs-2 leading-tight">Conférences & Congrès</h1>
            <p class="text-indigo-200 fs-5 mb-4 font-medium">Échangez, apprenez et grandissez</p>
            <p class="text-gray-400 small leading-relaxed">Découvrez des opportunités uniques de réseautage, de partage de connaissances et de formations professionnelles animées par des experts mondiaux de l'industrie.</p>
        ...
        <div class="row g-4">
            ...
            @empty
                <div class="col-12 text-center py-5 glass-card rounded-3xl">
                    ...
                    <h4 class="text-gray-400">Aucune conférence disponible</h4>
                    <p class="text-gray-500 small">Revenez plus tard pour voir les nouveaux événements professionnels !</p>
                </div>
            @endforelse
        </div>
