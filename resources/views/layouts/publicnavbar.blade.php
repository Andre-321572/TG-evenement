...
">
    <div style="max-width:1200px; margin:0 auto; padding:0 1.25rem; display:flex; align-items:center; justify-content:space-between; height:90px;">
        ...
        {{-- Logo --}}
        <a href="{{ url('/') }}" style="display:flex; align-items:center; text-decoration:none; height:90px; padding: 6px 0; box-sizing: border-box;">
            <img src="{{ asset('images/logo.png') }}" alt="HIT TECHNOLOGY" style="height:100%; max-height:78px; width:auto; border-radius: 8px;">
        </a>
        ...
        <div id="nav-links" style="display:flex; align-items:center; gap:0.25rem;">
            ...
            <a href="{{ route('p.evenement') }}"
               style="text-decoration:none; font-weight:600; font-size:.93rem; padding:.5rem .85rem; border-radius:8px; color:{{ Route::currentRouteName() == 'p.evenement' ? '#ffffff' : '#e2e8f0' }};"
            ...
            <div style="position:relative;" id="cat-dropdown-wrap">
                <button onclick="toggleDropdown('cat-menu')"
                        style="background:transparent; border:none; font-weight:600; font-size:.93rem; padding:.5rem .85rem; border-radius:8px; color:#e2e8f0; cursor:pointer; display:flex; align-items:center; gap:.3rem; font-family:'Outfit',sans-serif;"
                        onmouseover="this.style.background='rgba(255, 255, 255, 0.12)';" onmouseout="this.style.background='transparent';">
            ...
            <a href="{{ route('p.a-propos') }}"
               style="text-decoration:none; font-weight:600; font-size:.93rem; padding:.5rem .85rem; border-radius:8px; color:{{ Route::currentRouteName() == 'p.a-propos' ? '#ffffff' : '#e2e8f0' }};"
               onmouseover="this.style.background='rgba(255, 255, 255, 0.12)';" onmouseout="this.style.background='transparent';">
                À propos
            </a>

            <a href="{{ route('p.faq') }}"
               style="text-decoration:none; font-weight:600; font-size:.93rem; padding:.5rem .85rem; border-radius:8px; color:{{ Route::currentRouteName() == 'p.faq' ? '#ffffff' : '#e2e8f0' }};"
               onmouseover="this.style.background='rgba(255, 255, 255, 0.12)';" onmouseout="this.style.background='transparent';">
                FAQ
            </a>
            ...
            @guest
                <a href="{{ route('login') }}"
                   style="text-decoration:none; font-weight:700; font-size:.9rem; padding:.55rem 1.25rem; border-radius:10px; color:#1e40af; background:#ffffff; margin-left:.5rem; transition: all 0.2s;"
                   onmouseover="this.style.background='#f1f5f9'; this.style.color='#1d4ed8';" onmouseout="this.style.background='#ffffff'; this.style.color='#1e40af';">
                    Connexion
                </a>
            @else
                <div style="position:relative; margin-left:.5rem;" id="user-dropdown-wrap">
                    <button onclick="toggleDropdown('user-menu')"
                            style="background:rgba(255, 255, 255, 0.12); border:1px solid rgba(255, 255, 255, 0.2); font-weight:600; font-size:.9rem; padding:.45rem .9rem; border-radius:10px; color:#ffffff; cursor:pointer; display:flex; align-items:center; gap:.5rem; font-family:'Outfit',sans-serif;"
        ...
        <button id="hamburger-btn" onclick="toggleMobileMenu()"
                style="display:none; background:transparent; border:none; padding:.5rem; cursor:pointer; font-size:1.7rem; color:#ffffff; line-height:1; align-items:center; justify-content:center;">
